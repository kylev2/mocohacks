    ...
    <div className="body about">
      <div className="bg-color">
        <div className="page">
          ...
          <iframe title="MoCoHacks Video" src="https://www.youtube.com/watch?v=mY7rK9ma0h4" className="youtube" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="allowfullscreen"
